"""
Django settings for IAM_Belt project.
...
SECRET_KEY = 'p8q(_x7ao_%2z2(ob%9%)3$mlb_iq0o#9n655kd&o)fsp0$tc2'
...
WSGI_APPLICATION = 'IAM_Belt.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'belt_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
